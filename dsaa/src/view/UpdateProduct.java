    ...
    private void btnAddProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddProductActionPerformed
        ...
        String gpu = txtGPU.getText();                   
           ...
           if (maMay.equals("") || tenMay.equals("") || cpu.equals("") || ram.equals("") || rom.equals("") || gpu.equals("") || txtDonGia.getText() == "" || txtSoLuong.getText() == "") {
                ...
                int a = this.owner.getMayTinhSelect();
                Run.ProductData.get(a).setMaMay(maMay);
                        Run.ProductData.get(a).setTenMay(tenMay);
                        Run.ProductData.get(a).setSoLuong(Integer.parseInt(soluong));
                        Run.ProductData.get(a).setGia(Integer.parseInt(dongia));
                        Run.ProductData.get(a).setTenCpu(cpu);
                        Run.ProductData.get(a).setRam(ram);
                        Run.ProductData.get(a).setCardManHinh(gpu);
                        Run.ProductData.get(a).setRom(rom);
               
                this.dispose();
                JOptionPane.showMessageDialog(this, "Sửa sản phẩm thành công !");
                owner.loadDataToTable(Run.ProductData);
