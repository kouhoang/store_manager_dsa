...
public class ProductForm extends javax.swing.JInternalFrame {
    ...
    public ProductForm() {
        ...
        tblSanPham.setDefaultEditor(Object.class, null);
        initTable();
        loadDataToTable(Run.ProductData);
    }
    public final void initTable() {
        tblModel = new DefaultTableModel();
        String[] headerTbl = new String[]{"Mã máy", "Tên máy", "Số lượng", "Đơn giá", "Bộ xử lí", "RAM","Card màn hình", "Bộ nhớ"};
    ...
    public void loadDataToTable(ArrayList<Product> acc) {
       try {
  ...
  if (tblSanPham.getSelectedRow() == -1) {
    ...
    // TODO add your handling code here:
        ...
        ArrayList<Product> result = searchFn(luaChon, content);
 ...
 jComboBoxLuaChon.setSelectedIndex(0);
    ...
    public ArrayList<Product> searchFn(String luaChon, String content) {
     ...
     public Product getDetailProduct() {
        Product a = Run.ProductData.get(getMayTinhSelect());
        return a;
    }
    public void xoaMayTinhSelect() {
        ...
        if (luaChon == JOptionPane.YES_OPTION) {           
            ...
            Run.ProductData.remove(getMayTinhSelect());
            }
        }
...
//       
     ...
     public void loadDataToTableSearch(ArrayList<Product> result) {
        try {
            tblModel.setRowCount(0);
            for (Product i : result) {               
                tblModel.addRow(new Object[]{
                    i.getMaMay(), i.getTenMay(), i.getSoLuong(), formatter.format(i.getGia()) + "đ", i.getTenCpu(), i.getRam(), i.getRom() 
                });
            }
        } catch (Exception e) {
        }
