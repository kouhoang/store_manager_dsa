...
public class UpdateAccount extends javax.swing.JDialog {
    ...
    public UpdateAccount(javax.swing.JInternalFrame parent, javax.swing.JFrame owner, boolean modal) {
        ...
        Account acc = Run.AccountData.get(homeAcc.getAccountSelect());
        txtfullname.setText(acc.getFullName());
        txtusername.setText(acc.getUser());
        txtusername.setEditable(false);
        txtEmail.setText(acc.getPassword());
    ...
    private void btnupdateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnupdateMouseClicked
        ...
        String role = Run.AccountData.get(homeAcc.getAccountSelect()).getRole();
        
        String password = txtEmail.getText();
     
        Run.AccountData.get(homeAcc.getAccountSelect()).setFullName(fullName);
          Run.AccountData.get(homeAcc.getAccountSelect()).setUser(user);
                    Run.AccountData.get(homeAcc.getAccountSelect()).setPassword(password);
                    Run.AccountData.get(homeAcc.getAccountSelect()).setRole(role);
        this.dispose();
        homeAcc.loadDataToTable(Run.AccountData);       
