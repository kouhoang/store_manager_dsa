...
public class AddAccount extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 460, 140, 38));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 460, 140, 38));
  ...
  // TODO add your handling code here:
        ...
        if (fullName.equals("") || user.equals("") || password.equals("") || role.equals("") ) {
            JOptionPane.showMessageDialog(this, "Vui lòng nhập đầy đủ thông tin !", "Cảnh báo ", JOptionPane.WARNING_MESSAGE);
        } else {
            if (SearchAccount.getInstance().searchUserName(user) != null) {
                
                    Account acc = new Account(fullName, user, password, role);
                    Run.AccountData.add(acc);
                    this.dispose();
                    owner.loadDataToTable(Run.AccountData);                   
